      ...
      <div class="g-change-profile__inputs">
        ...
        >
          <template v-slot:error>
            <span v-if="!$v.name.required && $v.name.$error"
              >Имя обязателено</span
            >
            <span v-if="!$v.name.maxLength && $v.name.$error"
              >Максимальная длина имени
              {{ $v.name.$params.maxLength.max }} символов</span
            >
          </template>
        </g-input>
        ...
        <g-input
          :value="surname"
          @input.native="
            editProfileField({ value: $event.target.value, field: 'surname' })
          "
          class="g-change-profile__input"
          placeholder="Фамилия *"
          caption="Фамилия"
        ...
        >
          <template v-slot:error>
            <span v-if="!$v.surname.required && $v.surname.$error"
              >Фамилия обязателена</span
            >
            <span v-if="!$v.surname.maxLength && $v.surname.$error"
              >Максимальная длина фамилии
              {{ $v.surname.$params.maxLength.max }} символов</span
            >
          </template>
        </g-input>
        ...
        <g-input
          :value="nickname"
          @input.native="
            editProfileField({ value: $event.target.value, field: 'nickname' })
          "
          class="g-change-profile__input"
        ...
        >
          <template v-slot:error>
            <span v-if="!$v.nickname.required && $v.nickname.$error"
              >Никнэйм обязателен</span
            >
            <span v-if="!$v.nickname.maxLength && $v.nickname.$error"
              >Максимальная длина имени
              {{ $v.nickname.$params.maxLength.max }} символов</span
            >
            <span v-if="!$v.nickname.minLength && $v.nickname.$error"
              >Минимальная длина имени
              {{ $v.nickname.$params.minLength.max }} символов</span
            >
          </template>
        </g-input>
      </div>
...
export default {
  ...
  computed: {
    ...
    name: {
      ...
      set(val) {
        this.$store.dispatch('profile/editProfileField', {
          field: 'name',
          value: val,
        })
        this.$v.name.$touch()
