<template>
  <div class="g-sale-item" :class="{ 'g-sale-item_disabled': disabled }">
    ...
    <div class="g-sale-item__settings" :class="{ 'g-sale-item__settings_active': settings }">
    ...
    <div class="g-sale-item__img" :class="{ 'g-sale-item__img_disabled': disabled }">
      <img src="/images/sale-item-1.svg" alt="">
    </div>
    
    <div class="g-sale-item__block">
      <p class="g-sale-item__name" :class="{ 'g-sale-item__name_disabled': disabled }">Grand Theft Auto V: Premium Online Editiodf dsg sdfgdfgdf dfg dfh gdr </p>

      <g-price class="g-sale-item__price" :disabled="disabled" />

      <div class="g-sale-item__bottom">
        <p v-if="!disabled">Осталось: <span class="text-color-white">12 ключей</span></p>
        <p v-if="disabled" class="g-sale-item__keys" :class="{ 'g-sale-item__keys_disabled': disabled }"><span class="text-color-white">2 ключа</span></p>
