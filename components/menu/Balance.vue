<template>
  <div class="balance">
    <div class="balance__main" @click="showBalanceDrop = !showBalanceDrop">
    ...
    <div
      class="balance__drop"
      @mouseleave="showBalanceDrop = false"
      v-show="showBalanceDrop"
    >
