<template>
    <div class="g-slider genre-slider">
        ...
        <div class="g-slider__controls">
            <arrow-button @click.native="prev($refs.proposalSlider)" class="g-slider__button g-slider__button_left"
                          left/>
            <arrow-button @click.native="next($refs.proposalSlider)" class="g-slider__button g-slider__button_right"
                          right/>
        </div>
    </div>
</template>
