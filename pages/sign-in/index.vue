  ...
  <b-container>
    <div class="sign-in">
      ...
      <div class="sign-in__socials">
        <social-btn to="/auth/email" class="sign-in__social" icon-color="#643EFF" icon="/images/gameInComeBtn.svg" label="Через E-mail и пароль" />
        ...
        <social-btn to="/auth/email" class="sign-in__social" icon-color="#0C9CED" icon="/images/twitter.svg" label="Twitter" />
      </div>
    </div>
  </b-container>
</template>
