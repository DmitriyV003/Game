              ...
              <b-col xl="4" lg="4" md="4" sm="12">
                ...
                >
                  <div v-if="profile !== null" class="g-user-stat">
                    <span class="g-user-stat__title">{{ profile.purchaseCount }}</span>
              ...
              <b-col xl="4" lg="4" md="4" sm="12">
                <transition mode="out-in">
                  <div 
                    ...
                    key="item-2"
                  >
                    <span class="g-user-stat__title">{{ profile.feedbackOnSellersCount }}</span>
              ...
              <b-col xl="4" lg="4" md="4" sm="12">
                <transition mode="out-in">
                  <div 
                    ...
                    key="item-3"
                  >
                    <span class="g-user-stat__title">{{ profile.reviewsCount }}</span>
