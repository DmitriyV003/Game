          ...
          <form @submit.prevent="changePassword" class="g-manage-password">
            <div class="g-manage-password__top">
              ...
              <show-all
                ...
                class="g-manage-password__forget_desktop"
                :icon="false"
                label="Забыли пароль?"
              />
            </div>
                ...
                <div class="g-manage-password__input">
                  ...
                  >
                    ...
                    <template v-slot:link>
                      <show-all
                        @click.native="
                          eventBus.$emit('passwordRecoveryPopupOpen')
                        "
              ...
              <div class="g-manage-password__line">
                <div class="g-manage-password__input">
                  <g-input
                    ...
                    :error="
                      $v.form.newPassword.$error || 'password' in apiErrors
                    "
                  >
                    <template v-slot:error>
                      <span
                      ...
                      <span
                        ...
                        {{
                          $v.form.newPassword.$params.maxLength.min
                        }}
                        символов</span
                      >
                    </template>
                ...
                <div class="g-manage-password__input">
                  <g-input
                    ...
                    :error="
                      $v.form.repeatNewPassword.$error ||
                      'password' in apiErrors
                    "
                  >
                    <template v-slot:error>
                      <span
                        v-if="
                          !$v.form.repeatNewPassword.required &&
                          $v.form.repeatNewPassword.$error
                        "
                        >Пароль обязателен</span
                      >
                      <span
                        v-if="
                          !$v.form.repeatNewPassword.sameAsPassword &&
                          $v.form.repeatNewPassword.$error
                        "
