                    ...
                    <form @submit.prevent="changePassword" class="g-manage-password">
                        <div class="g-manage-password__top">
                            ...
                            <show-all
                                ...
                                class="g-manage-password__forget_desktop" :icon="false" label="Забыли пароль?"
                            />
                        </div>
                            ...
                            <div class="g-manage-password__line">
                                ...
                                <div class="g-manage-password__input">
                                    ...
                                    >
                                        <template v-slot:error>
                                            <span
                                                v-if="!$v.form.repeatNewPassword.required && $v.form.repeatNewPassword.$error">Пароль обязателен</span>
                                            <span
                                                v-if="!$v.form.repeatNewPassword.sameAsPassword && $v.form.repeatNewPassword.$error">Пароли не совпадают</span>
                                        </template>
                                    </g-input>
                                </div>
                            </div>
            ...
            async changePassword() {
                try {
                    ...
                    if (this.statusCode === 422) {
                        ...
                        this.showToast('Проверьте все пункты!', 'danger', 'Ошибка в заполнении формы!')
                    }
                    if (this.statusCode === 400) {
                        this.warning = e.response.data.warning

                        this.showToast(this.warning, 'danger', 'Что-то пошло не так(')
                    }

                    this.showToast('Непредвиденная ошибка!', 'danger', 'Что-то пошло не так(')
                } finally {
                    this.disabled = false
                }
            },
