                ...
                <b-col xl="9" lg="9">
                    ...
                    <div class="g-questions__table">
                        <div class="g-questions__table-header">
                            ...
                            <main-button @click.native="eventBus.$emit('newQuestionPopupOpen')"
                                         class="g-questions__btn_desktop" size="xl" label="новый вопрос"
                                         color="primary"/>
                            <button @click="eventBus.$emit('newQuestionPopupOpen')"
