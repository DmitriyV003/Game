            ...
            <b-container>
                ...
                <div class="g-sellers-banner">
                    ...
                    <div class="g-sellers-banner__content">
                        <h2>Gameincome</h2>
                        <p class="g-sellers-banner__text">Надёжный маркетплейс с каталогом, в котором более 5000 ключей
                            для игр, 300 видов авторских софтов, публичной и часто посещаемой вертелкой для кейсов и
                            скинов из игр DOTA 2 и CS GO</p>
...
<script>
    ...
    export default {
        name: 'GForSellers',
        components: { GPromoBanner, GSellerComment, SectionHeader, GTypeItem, MainButton, GInfoItem, BreadCrumb },
        layout: 'default',
        methods: {
            async becomeSeller () {
                this.disabled = true
