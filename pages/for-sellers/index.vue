<template>
  <div>
        ...
        <div class="g-offers__all">
          <div class="g-offers">
            ...
            <div class="g-offers__offer g-offers__offer_text">
              ...
              <p class="g-offers__text">Комиссия нашего маркетплейса - <span>1%</span>!</p>
            </div>
          </div>
          <div class="g-offers g-offers_reverse">
            ...
            <div class="g-offers__offer g-offers__offer_text">
              ...
              <p class="g-offers__text">На нашем сайте покупателям тепло и уютно.
                Очень легко скупаются игры даже на самых заснеженных страницах нашего каталога</p>
            </div>
          </div>
          <div class="g-offers">
            <div class="g-offers__offer g-offers__bg">
            ...
            <div class="g-offers__offer g-offers__offer_text">
              ...
              <p class="g-offers__text">Приятный менеджер и отзывчивая администрация устроят вам
                приём по традициям Gameincome</p>
            </div>
          </div>
        </div>
    ...
    <section class="section">
      <b-container>
        <div class="for-sellers-banner">
          <img src="/images/seller-banner.png" alt="" class="for-sellers-banner__img">
          <h2 class="for-sellers-banner__title">Один шаг на пути к сотрудничеству!</h2>
          <main-button color="primary" size="xl" label="стать продавцом" />
        </div>
      </b-container>
    </section>
...
export default {
  name: 'GForSellers',
  components: {GSellerComment, SectionHeader, GTypeItem, MainButton, GInfoItem, BreadCrumb},
  layout: 'default',
  data: () => {
    return {
      links: [
